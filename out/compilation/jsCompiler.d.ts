...
export declare const compileExportStatement: (node: IAstNode, state: ICompilerState) => ICompileResult<IAstExportStatement>;
...
export declare const compileFuncExpression: (node: IAstNode, state: ICompilerState) => ICompileResult<IAstFunctionExpression>;
...
export declare const compileTypeofExpression: (node: IAstNode, state: ICompilerState) => ICompileResult<IAstTypeofExpression>;
...
export declare const compileStaticStatement: (node: IAstNode, state: ICompilerState) => ICompileResult<IAstStaticStatement>;
...
export declare const compileObjectLiteral: (node: IAstNode, state: ICompilerState) => ICompileResult<IAstObjectLiteral>;

...
export declare const subitemsToString: (obj: any, separator: any, headerTag: any, headerAttr: any, contentTag: any, contentAttr: any) => string;
export declare const clearText: (context: any) => any;

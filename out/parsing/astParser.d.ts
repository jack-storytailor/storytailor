...
export declare const parseStringLiteral: (state: IParserState) => IParseResult<IAstString>;
...
export declare const parseImportPath: (state: IParserState) => IParseResult<IAstString>;

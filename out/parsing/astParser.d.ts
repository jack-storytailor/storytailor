...
export declare const parseExportStatement: (state: IParserState, isMultiline: boolean) => IParseResult<IAstKeywordNode>;
export declare const parseStaticStatement: (state: IParserState, isMultiline: boolean) => IParseResult<IAstKeywordNode>;
export declare const parseBreakStatement: (state: IParserState) => IParseResult<IAstBreakStatement>;
export declare const parseReturnStatement: (state: IParserState, isMultiline: boolean) => IParseResult<IAstKeywordNode>;
...
export declare const parseImportStatement: (state: IParserState, isMultiline: boolean) => IParseResult<IAstImportStatement>;
export declare const parseImportPath: (state: IParserState) => IParseResult<IAstNode>;
export declare const parseRawImportStatement: (state: IParserState, isMultiline: boolean) => {
    state: IParserState;
    result: import("../ast/IAstNode").IAstRawImportStatement;
};
export declare const parseImportItem: (state: IParserState, isMultiline: boolean) => IParseResult<IAstImportItem>;
...
export declare const parseCodeBlock: (state: IParserState, isMultiline: boolean) => IParseResult<IAstBlockStatement>;
export declare const parseFunctionParameters: (state: IParserState, isMultiline: boolean) => IParseResult<IAstNode[]>;
export declare const parseObjectLineTags: (state: IParserState, isMultiline: boolean) => IParseResult<IAstNode[]>;
export declare const parseLiteral: (state: IParserState, isMultiline: boolean) => IParseResult<IAstNode>;
...
export declare const parseRegexLiteral: (state: IParserState) => IParseResult<IAstRegexLiteral>;
export declare const parseRegexParenScope: (state: IParserState) => IParseResult<{
    value: string;
...
export declare const parseObject: (state: IParserState) => IParseResult<IAstObject>;
...
export declare const parseClassDeclaration: (state: IParserState, isMultiline: boolean) => IParseResult<IAstClassDeclaration>;
export declare const parseClassMember: (state: IParserState, isMultiline: boolean) => IParseResult<IAstNode>;
...
export declare const parseKeywordExpression: (state: IParserState, isMultiline: boolean) => IParseResult<IAstKeywordNode>;
export declare const parseOperationExpression: (state: IParserState, isMultiline: boolean) => IParseResult<IAstNode>;
...
export declare const parseNewExpression: (state: IParserState, isMultiline: boolean) => IParseResult<IAstKeywordNode>;
export declare const parseAwaitExpression: (state: IParserState, isMultiline: boolean) => IParseResult<IAstKeywordNode>;
export declare const parseYieldExpression: (state: IParserState, isMultiline: boolean) => IParseResult<IAstKeywordNode>;
export declare const parseDeleteExpression: (state: IParserState, isMultiline: boolean) => IParseResult<IAstKeywordNode>;
export declare const parseTypeofExpression: (state: IParserState, isMultiline: boolean) => IParseResult<IAstKeywordNode>;
export declare const parsePrototypeExpression: (state: IParserState) => IParseResult<IAstPrototypeExpression>;
export declare const parseTag: (state: IParserState) => IParseResult<IAstNode>;
export declare const parseNode: (state: IParserState, isMultiline: boolean, parsers: ParserFunction[]) => IParseResult<IAstNode>;
export declare const parseKeywordNode: (state: IParserState, isKeywordFirst: boolean, isMultiline: boolean, keywords: KeywordType[], parsers: ParserFunction[]) => IParseResult<IAstKeywordNode>;
